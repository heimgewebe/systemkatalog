...
| Lenskit-Legacyrolle | concept | `transition` · geprüft 2026-08-02 | `supporting` | host:heim-pc<br>runtime:lenskit-legacy | bounded Lenskit/rLens compatibility and rollback role retained during the RepoGround cutover, not a separate product, repository or live-status authority | independent product or repository authority alongside RepoGround<br>primary ownership of repository context or citations<br>task state, merge authorization or live runtime health<br>indefinite retention after the RepoGround cutover is verified | — | `cutoverContract`: [https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground-3-migration.md](https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground-3-migration.md)<br>`migrationInventory`: [https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground-3-migration-inventory.v1.json](https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground-3-migration-inventory.v1.json)<br>`productArchitecture`: [https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground.md](https://github.com/heimgewebe/repoground/blob/5548ca2d23a3d22ffe14fb1006363e4078e7c009/docs/architecture/repoground.md) |
...
| RepoGround | `scope_boundary` | Lenskit-Legacyrolle | `bounded` | `manual` | `fallback` | `none` | `repoground-legacy-rollback` | RepoGround is the current product and repository-context authority; Lenskit/rLens remains only a bounded compatibility and rollback runtime during cutover. |
