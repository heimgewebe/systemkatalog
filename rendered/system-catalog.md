...
| GewebeZell-Betreiberrolle | concept | `active` · geprüft 2026-08-01 | `supporting` | — | local responsibility for cell infrastructure, moderation, rules, data boundaries and explicitly allowed federation relationships | canonical truth of foreign cells<br>global ecosystem governance<br>authority derived only from technical reachability<br>Bureau task state or Grabowski execution authorization | — | `architecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md)<br>`incidentResponse`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/incident-response.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/incident-response.md)<br>`operatorRunbook`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbook.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbook.md) |
| GewebeZelle | concept | `active` · geprüft 2026-08-01 | `supporting` | — | autonomous operational and social domain with local data sovereignty, moderation, rules, infrastructure boundaries and explicit federation relationships | global multi-primary truth<br>canonical state of foreign cells<br>implicit sharing of private data<br>claims about a cell runtime without primary-source observation | weltgewebe_cell_domain_truth | `architecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md)<br>`cellDescriptor`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/contracts/federation/v1/cell-descriptor.schema.json](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/contracts/federation/v1/cell-descriptor.schema.json)<br>`federationDecision`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0011__foederierte-gewebezellen.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0011__foederierte-gewebezellen.md) |
| Weltgewebe OS | concept | `active` · geprüft 2026-08-01 | `supporting` | — | canonical target architecture for a federated, locally sovereign and globally connected societal coordination layer | device operating systems<br>claims that the current runtime already satisfies the target architecture<br>live Kubernetes, high-availability or public federation status | — | `architecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md)<br>`foundationStatus`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/weltgewebe-os-foundation-status.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/weltgewebe-os-foundation-status.md)<br>`masterplan`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/blueprints/weltgewebe-os-masterplan.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/blueprints/weltgewebe-os-masterplan.md) |
| Weltgewebe-Föderationsebenen | concept | `active` · geprüft 2026-08-01 | `supporting` | — | separation of same-operator infrastructure federation, trusted-neighbour event federation and public domain federation between independent cells | global primary truth<br>unrestricted internal Kubernetes or NATS access between operators<br>claims that public cell federation is already operational | — | `architecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md)<br>`federationDecision`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0011__foederierte-gewebezellen.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0011__foederierte-gewebezellen.md)<br>`wireContract`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/specs/federation-wire-v1.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/specs/federation-wire-v1.md) |
| Weltgewebe-Plattformziel | concept | `transition` · geprüft 2026-08-01 | `supporting` | — | Kubernetes- and GitOps-based target platform for staging and production while Compose remains a real, bounded development and recovery profile | claiming that Kubernetes production operation is already proven<br>live deployment or cluster health<br>manual runtime changes as durable desired state | — | `architecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md)<br>`foundationStatus`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/kubernetes-platform-foundation-status.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/kubernetes-platform-foundation-status.md)<br>`platformDecision`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0010__kubernetes-kanonische-plattform.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/adr/ADR-0010__kubernetes-kanonische-plattform.md)<br>`recoveryProof`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/kubernetes-ha-recovery-proof.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/kubernetes-ha-recovery-proof.md) |
...
| commonThing | repository | `active` · geprüft 2026-08-01 | `essential` | host:wg-prod-1<br>data:weltgewebe-postgresql<br>stream:weltgewebe-jetstream<br>network:public-internet<br>credentials:operator<br>provider:backup-storage | canonical source repository implementing the Weltgewebe OS product and domain core | ecosystem governance<br>fleet task orchestration<br>global multi-primary domain truth<br>claims about live Kubernetes, high-availability or public federation readiness | weltgewebe_target_architecture | `federationContract`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/contracts/federation/v1](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/contracts/federation/v1)<br>`foundationStatus`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/weltgewebe-os-foundation-status.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/reports/weltgewebe-os-foundation-status.md)<br>`operatorRunbook`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbook.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbook.md)<br>`recoveryRunbook`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/kubernetes-ha-recovery-proof.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/docs/runbooks/kubernetes-ha-recovery-proof.md)<br>`repository`: [https://github.com/heimgewebe/commonthing](https://github.com/heimgewebe/commonthing)<br>`targetArchitecture`: [https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md](https://github.com/heimgewebe/commonthing/blob/322655285b520d04363e48487ae64d57264de573/architecture/weltgewebe-os.md) |
...
| Großer Adler | repository | `active` · geprüft 2026-09-16 | `optional` | identity:github<br>provider:github | independent read-mostly observer for evidence-bound cross-system inspection and append-only advisory findings | task state<br>operational execution<br>merge or deployment authority<br>automatic remediation | — | `repository`: [https://github.com/heimgewebe/grosser-adler](https://github.com/heimgewebe/grosser-adler) |
| heim-pc | repository | `active` · geprüft 2026-08-13 | `unknown` | identity:github<br>provider:github | Versioned local operator entry, host orientation and host-local capability locators | fleet task authority<br>service runtime truth<br>ecosystem semantics | — | `asrArchitecture`: [https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/architecture/asr-engine.md](https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/architecture/asr-engine.md)<br>`asrEntrypoint`: [https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/scripts/asr_engine.py](https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/scripts/asr_engine.py)<br>`asrPolicy`: [https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/manifest/asr-engine-policy.v1.json](https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/manifest/asr-engine-policy.v1.json)<br>`operatorEntry`: [https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/manifest/operator-entry.v1.json](https://github.com/heimgewebe/heim-pc/blob/671565d78b115cf2205d8a05bdeb709ac998f428/manifest/operator-entry.v1.json)<br>`repository`: [https://github.com/heimgewebe/heim-pc](https://github.com/heimgewebe/heim-pc) |
| Heim-PC Dashboard ChatGPT App | repository | `active` · geprüft 2026-09-01 | `optional` | identity:github<br>provider:github | private source repository implementing the local read-only ChatGPT dashboard service | canonical truth ownership<br>task authorization or prioritization<br>claim or dispatch authority<br>runtime mutation or execution<br>general operator display ownership | — | `boundary`: [docs/architecture/heim-pc-chatgpt-dashboard-boundary.md](../docs/architecture/heim-pc-chatgpt-dashboard-boundary.md)<br>`repository`: [https://github.com/heimgewebe/heim-pc-dashboard-chatgpt-app](https://github.com/heimgewebe/heim-pc-dashboard-chatgpt-app) |
...
| commonThing | `heimgewebe/commonthing` | `related` | [https://github.com/heimgewebe/commonthing](https://github.com/heimgewebe/commonthing) |
...
| Großer Adler | `heimgewebe/grosser-adler` | `catalog-only` | [https://github.com/heimgewebe/grosser-adler](https://github.com/heimgewebe/grosser-adler) |
| heim-pc | `heimgewebe/heim-pc` | `fleet` | [https://github.com/heimgewebe/heim-pc](https://github.com/heimgewebe/heim-pc) |
| Heim-PC Dashboard ChatGPT App | `heimgewebe/heim-pc-dashboard-chatgpt-app` | `catalog-only` | [https://github.com/heimgewebe/heim-pc-dashboard-chatgpt-app](https://github.com/heimgewebe/heim-pc-dashboard-chatgpt-app) |
...
| Labor | `heimgewebe/labor` | `catalog-only` | [https://github.com/heimgewebe/labor](https://github.com/heimgewebe/labor) |
...
Der GitHub-Snapshot umfasst 29 nicht geforkte Repositories. Davon sind 27 aktive Katalogsysteme, 0 archivierte Referenzen und 2 begründet ausgeschlossen.
...
| `bounded_experiments` | `labor` | systemkatalog |
...
| `reviewed_learning_proposals` | `labor` | bureau, systemkatalog |
...
| `wgx_profile_runner_contract` | `wgx` | github_ci |
...
| Chronik | `learning_input_for` | Labor | `bounded` | `observational` | `degrade` | `from-to` | `—` | Chronik may supply frozen historical outcome cohorts as evidence for prospectively registered Labor experiments; no policy or task is auto-applied. |
...
| commonThing | `operates_on` | GitHub | `stable` | `synchronous-blocking` | `block` | `to-from` | `—` | commonThing repository work is validated through GitHub repository, PR and CI state. |
| commonThing | `provides` | Weltgewebe OS | `stable` | `—` | `—` | `—` | `—` | The commonThing repository carries the normative Weltgewebe OS target architecture and its product implementation. |
...
| Heim-PC Dashboard ChatGPT App | `implements` | Heim-PC ChatGPT Dashboard | `stable` | `—` | `—` | `—` | `—` | The private repository contains the implementation of the local ChatGPT access surface; this code-source relation grants no task, priority, claim, dispatch, execution or general operator-display authority. |
...
| Labor | `exports_candidate_to` | Bureau | `bounded` | `manual` | `degrade` | `from-to` | `—` | Labor may export reviewed proposal-ready candidates; Bureau alone decides whether they become work. |
| Labor | `provides` | Systemkatalog | `stable` | `—` | `—` | `—` | `—` | Labor provides method experiments and evidence patterns. |
...
| WGX | `provides` | CI / Checks | `stable` | `—` | `—` | `—` | `—` | WGX executes repository-declared WGX profile validation as an optional CI runner; target repositories own task declarations and CI owns result truth. |
...
| `weltgewebe-jetstream-recovery` | `repo:commonthing` | `restore` | `partially-shared` | credentials:operator | Stream consumers, deduplication, ordering and representative end-to-end behavior pass without split brain. |
| `weltgewebe-postgresql-restore` | `repo:commonthing` | `restore` | `partially-shared` | credentials:operator | A clean target passes schema, integrity, representative API, authentication and domain readbacks. |
