...
| Heimgewebe-Systemkatalog | repository | app-independent system catalog for purpose, truth ownership, stable relations and entrypoints |
...
| `bounded_experiments` | `vibe_lab` | heimgewebe_katalog |
| `branches_prs_reviews` | `github` | bureau, leitstand |
| `ecosystem_semantics` | `heimgewebe_katalog` | leitstand, schauwerk |
| `general_operator_display` | `leitstand` | — |
| `live_service_state` | `runtime` | leitstand |
| `local_fleet_execution` | `grabowski` | leitstand |
| `offline_learning_proposals` | `heimlern` | heimgewebe_katalog |
| `repository_context_citations` | `repobrief_lenskit` | rlens, heimgewebe_katalog |
...
|---|---|---|---|---|
| Alexander | `steers` | Heimgewebe-Systemkatalog | `stable` | Human sense, priority, approval and abort authority stay outside automation. |
| RepoBrief | `provides` | Heimgewebe-Systemkatalog | `stable` | RepoBrief gives Heimgewebe-Systemkatalog citable repository context. |
...
| Chronik | `provides` | Heimgewebe-Systemkatalog | `stable` | Chronik provides event trace and historical continuity. |
...
| Heimgewebe-Systemkatalog | `owns` | Ecosystem Map v0 | `stable` | Heimgewebe-Systemkatalog owns the map semantics during v0. |
| Heimgewebe-Systemkatalog | `provides` | Leitstand | `stable` | Heimgewebe-Systemkatalog provides map artifacts for Leitstand display. |
...
| Steuerboard | `observes` | Heimgewebe-Systemkatalog | `stable` | Steuerboard can provide read-only repo-state signals, not decisions. |
| Vibe-Lab | `provides` | Heimgewebe-Systemkatalog | `stable` | Vibe-Lab provides method experiments and evidence patterns. |
...
| Heimgewebe-Systemkatalog | [README.md](../README.md) |
