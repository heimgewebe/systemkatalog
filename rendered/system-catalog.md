...
| Steuerboard | repository | `active` · geprüft 2026-07-26 | `unknown` | identity:github<br>provider:github | read-only repo-state signal | task authorization<br>merge approval<br>runtime mutation | repository_observation_readiness | `repository`: [https://github.com/heimgewebe/steuerboard](https://github.com/heimgewebe/steuerboard) |
