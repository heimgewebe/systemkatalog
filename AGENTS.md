...
- Gemini: vorgeschlagene proposal-only Review-/Scout-Kapazität nach Capability- und Sandbox-Preflight; nicht verifiziert, nicht schedulable, keine Push-, Merge-, Runtime- oder private-Kontext-Autorität.
