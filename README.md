...
6. [Stabile Resilienzsemantik](registry/ecosystem/resilience.v1.json)
7. [Wahrheitszuständigkeiten](registry/ecosystem/authority-matrix.v1.json)
8. [Agenteneinstieg](AGENTS.md)
9. [Architektur](docs/architecture/systemkatalog.md)
10. [Audit der früheren Cabinet-Räume](docs/audits/systemkatalog-room-audit-v1.md)
11. [Resilienz-Gap-Matrix v1](docs/audits/heimgewebe-resilience-gap-matrix-v1.md)
...
- `registry/ecosystem/*.json` und `claims.jsonl` als kanonische Daten, einschließlich statusfreier Resilienzsemantik;
